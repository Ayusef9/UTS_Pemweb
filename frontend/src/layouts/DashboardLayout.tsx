            ...
            <div className="min-h-screen bg-[#852e4e] w-64 flex flex-col justify-between p-4">
                ...
                <div>
                    <nav className="flex flex-col gap-2">
                        ...
                        <Link to="/dashboard/categories" className="p-4 text-white text-lg hover:bg-black transition ease-in-out duration-150">
                            <span>
                                <FolderIcon size={18} />
                            </span>
                            Categories
                        ...
                        <Link to="/dashboard/biodata" className="p-4 text-white text-lg hover:bg-black transition ease-in-out duration-150">
                            <span>
                                <UsersIcon size={18} />
                            </span>
                            Biodata
